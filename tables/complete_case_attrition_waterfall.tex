...
\vspace{0.2em}
\begin{minipage}{0.92\textwidth}\scriptsize \textit{Source:} Author's calculations from the merged Eurostat panel. Percentages use the 608 outcome-observed rows as the reference target.\end{minipage}
\end{table}
