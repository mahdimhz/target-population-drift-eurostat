...
\vspace{0.2em}
\begin{minipage}{0.96\textwidth}\scriptsize Notes: Row counts refer to the generated thesis pipeline. Balanced-outcome means balanced for the primary outcome and population weights, not for every regression covariate. MAR and MNAR imputation estimates are sensitivity estimates, not true coefficients.\end{minipage}
