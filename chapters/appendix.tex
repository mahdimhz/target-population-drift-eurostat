...
Formal drift-stability metrics, TDI, and CSI outputs & Drift-stability builder & Outcome-by-estimand matrix and multi-outcome processed panel \\
Semi-synthetic missingness simulation and TDI validation & Simulation & Reference panel and simulation configuration \\
...
\begin{itemize}
    ...
    \item the multi-outcome builders create the public-data estimand registry, monitoring benchmark, drift diagnostics, coefficient matrix, and deterministic classification inputs;
    \item the drift-stability builder creates formal estimand-component, target-drift, TDI, standardized-coefficient, and CSI outputs;
    \item the simulation script creates reference-estimand missingness simulations, TDI/error figures, and wrong-conclusion diagnostics;
    \item the reporting-protocol script creates the reporting checklist, failure-mode table, and final classification table;
