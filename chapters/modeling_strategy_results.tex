...
\caption{Distribution of the poverty/social-exclusion coefficient across the 30 baseline PMM imputations. The pooled estimate attenuates toward zero, but the distribution is interpreted as model-based sensitivity rather than proof of the true coefficient.}
...
The MI attenuation is interpreted as model-based instability under a broader target population, not as evidence that the imputed coefficient is the true coefficient. It may reflect target-population sensitivity, imputation-model dependence, MAR violations, or structural Eurostat non-coverage. The imputation model itself is part of the sensitivity design. The MI estimates are not treated as truth. They test whether the complete-case poverty coefficient is stable under broader model-based targets; it is not.
