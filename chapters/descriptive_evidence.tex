...
The East/South and West/North grouping is used only as a compact coverage diagnostic. It is a descriptive partition of the country list used to summarize retention patterns, not a theory of European health systems and not a causal modifier. Institutional country universes such as EU-27, EEA countries, Switzerland, the UK, and candidate or potential-candidate countries are defined separately in Chapter~\ref{ch:data_indicators}.
...
Country heterogeneity remains useful, but it is no longer the centre of the chapter. The country ranking and country-year outcome heatmap are generated for reproducibility and listed in the output map, but they are not reproduced in the main text because they are descriptive context rather than evidence for the target-population drift claim. Their role is to motivate country structure in the models and to show why a selected complete-case panel may not represent the same monitoring object as the full outcome-observed panel.
